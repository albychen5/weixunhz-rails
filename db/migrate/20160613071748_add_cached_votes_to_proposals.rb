class AddCachedVotesToProposals < ActiveRecord::Migration
  def self.up
    ...
    Proposal.find_each(&:update_cached_votes)
  end

  def self.down
    remove_column :proposals, :cached_votes_total
    remove_column :proposals, :cached_votes_score
    remove_column :proposals, :cached_votes_up
    remove_column :proposals, :cached_votes_down
    remove_column :proposals, :cached_weighted_score
    remove_column :proposals, :cached_weighted_total
    remove_column :proposals, :cached_weighted_average
  end
end
